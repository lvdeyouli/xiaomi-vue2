  ...
  <div class="top-header">
    <div class="container">
      ...
      <div class="header-search" :class="{'search-active':hotStatus}">
        ...
        <input @focus="hotStatus=true" @blur="hotStatus=false"
        ...
        <ul class="search-result clearfix" v-show="hotStatus">
          <li v-for="item in results" class="result">
    ...
    <transition name="fadein">
      <div class="header-menu" @mouseenter="evtHeaderEnter()" @mouseleave="evtHeaderLeave()" v-show="headerStatus">
  ...
  export default {
    ...
    methods: {
      evtHeaderEnter(menuType) {
        menuType && (this.currentPhones = this[menuType])
        this.headerStatus = true
        clearTimeout(this.tids)
      },
      evtHeaderLeave() {
        this.tids = setTimeout(() => {
