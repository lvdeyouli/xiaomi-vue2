<template>
  <div class="Container">
    <goods-title :title="title"></goods-title>
    <div class="box-bd">
      <ul class="container-list">
        <li>
          <template v-for="(content, index) in contents">
            <goods-content-slide :content="content" :index="index"></goods-content-slide>
          </template>
        </li>
      </ul>
    </div>
...
<script type="text/ecmascript-6">
  import goodsTitle from './common/goodsTitle.vue'
  import goodsContentSlide from './common/goodsContentSlide.vue'
